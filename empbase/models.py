...
class Funcionario(Base):
    ...
    pis = models.CharField(max_length=150)
    admissao = models.DateField()
    salario = models.FloatField(blank=True, null=True)
    cargo = models.CharField(max_length=150)
    cbo = models.CharField(max_length=150, default=None)
    rg = models.CharField(max_length=150, blank=True, null=True)
    rgemiss = models.DateField(max_length=150, blank=True, null=True)
    rgorgao = models.CharField(max_length=150, blank=True, null=True)
    ctps = models.CharField(max_length=150, default=None)
    ctpsserie = models.CharField(max_length=150, default=None)
    ctpsdata = models.DateField(blank=True, null=True)
    ctpsuf = models.CharField(max_length=150, default=None)
    jornada = models.ForeignKey(Turno, on_delete=models.DO_NOTHING, default=7352)
    logradouro = models.CharField(max_length=150, default=None)
    num = models.CharField(max_length=150, default=None)
    bairro = models.CharField(max_length=150, default=None)
    cidade = models.CharField(max_length=150, default=None)
    uf = models.CharField(max_length=150, default=None)
    cep = models.IntegerField(default=None)
    datanasc = models.DateField(default=None)
    cidadenasc = models.CharField(max_length=150, default=None)
    ufnasc = models.CharField(max_length=150, default=None)
    genero = models.CharField(max_length=150, default=None)
    pai = models.CharField(max_length=150, blank=True, null=True)
    mae = models.CharField(max_length=150, default=None)
...
class Rescisao(Base):
    ...
    emp = models.ForeignKey('Empresa', on_delete=models.DO_NOTHING)
    func = models.ForeignKey(Funcionario, on_delete=models.CASCADE)
    tiporescisao = models.CharField(max_length=150, choices=Tipo.choices, blank=True, null=True)
    tipoaviso = models.CharField(max_length=150, blank=True, null=True)
...
class Holerite(Base):
    ...
    emp = models.ForeignKey('Empresa', on_delete=models.DO_NOTHING)
    tipo = models.CharField(max_length=150, choices=Tipo.choices)
    comp = models.DateField()
...
class Obras(Base):
    ...
    cnpj = models.CharField(max_length=150, null=True, blank=True)
    cno = models.CharField(max_length=150, null=True, blank=True)
    nome = models.CharField(max_length=150)
    endereco = models.CharField(max_length=150)
...
class TiposGuia(Base):
    nome = models.CharField(max_length=150)
    ident_titular = models.CharField(max_length=150)
    ident_titular_regex = models.CharField(max_length=150, null=True, blank=True)
    ident_tipo_guia = models.CharField(max_length=150)
    ident_cod_guia = models.CharField(max_length=150)
    forma_pagamento = models.CharField(max_length=150, null=True, blank=True)
    comp_regex = models.CharField(max_length=150, default='(Janeiro|Fevereiro|Março|Abril|Maio|Junho|Julho|Agosto|Setembro|Outubro|Novembro|Dezembro)/\d{4}')
...
class Imposto(Base):
    ...
    identificador = models.CharField(max_length=150, null=True, blank=True)
